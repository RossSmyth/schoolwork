function [time,displacement] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIME,DISPLACEMENT] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [TIME,DISPLACEMENT] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [time,displacement] = importfile('part_2.data',1, 5001);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/02/18 21:09:51
